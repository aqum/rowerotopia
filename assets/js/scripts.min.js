...
$(document).on('click', '[data-drawer-toggle]', function(e) {
  $('body').addClass('drawer-active');
  e.stopPropagation();
});

$(document).on('click', '.rt-drawer', function(e) {
  e.stopPropagation();
});

$(document).on('click', '.drawer-active', function() {
...
$(document).on('click', '.rt-map[href]:not(.iframe-inside)', function(e) {
  e.preventDefault();

  var $this = $(this);
  var iframe_url = $this.attr('href');
  var iframe = $('<iframe/>').attr('src', iframe_url);

  $this.addClass('iframe-inside');
  $this.css('height', $(window).height() - 150);
  $this.html(iframe);
});

$(document).on('click', '[href=#mapa]', function() {
  $('.rt-map[href]:not(.iframe-inside)').trigger('click');
});
